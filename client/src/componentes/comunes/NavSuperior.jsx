...
import "../../estilos/NavSuperior.scss";
...
class NavSuperior extends Component {
  ...
  // Cerrar menú desplegable cuando haga clic afuera
  handleClick = e => {
  ...
  render() {
    const { name, email } = this.props.autenticacion.user;
          ...
          <li>
            ...
            {this.state.dropdown ? (
              <ul className="dropdown">
                ...
                */}
                <li onClick={this.onLogoutClick}>Cerrar sesión</li>
              </ul>
            ) : null}
          </li>
        </ul>
